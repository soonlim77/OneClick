...
{
    public class SE2EmailContent : IEmailContent
    {
        public EmailInfo ConstructBody(EmailInfo e, int part)
        {

            e.Content = new EmailContent("Help Desk Follow up Email #2 on ticket " + e.Ticket);
        ...
        private string ConstructSEContent(EmailInfo e)
        {
            ...
            e.Content.Body += "<br><p style='font-family:GT Walsheim Pro;font-size:11pt'>This ticket will be closed in <b> 2 </b>days, if we do not hear from you.<br>";
